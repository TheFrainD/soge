...
A window object encapsulates both a top-\/level window and an Open\+GL or Open\+GL ES context. It is created with \mbox{\hyperlink{group__window_ga680a02abe0e4494b6759d5703240713e}{glfw\+Create\+Window}} and destroyed with \mbox{\hyperlink{group__window_ga806747476b7247d292be3711c323ea10}{glfw\+Destroy\+Window}} or \mbox{\hyperlink{group__init_gafd90e6fd4819ea9e22e5e739519a6504}{glfw\+Terminate}}. See \mbox{\hyperlink{window_guide_window_creation}{Window creation}} for more information.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__window_ga3c96d80d363e67d13a41b5d1821f3242}{GLFWwindow}}* second\_window = \mbox{\hyperlink{group__window_ga680a02abe0e4494b6759d5703240713e}{glfwCreateWindow}}(640, 480, \textcolor{stringliteral}{"Second Window"}, \mbox{\hyperlink{include_2vally_2config_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}}, first\_window);}
\end{DoxyCode}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{group__window_ga3c96d80d363e67d13a41b5d1821f3242}{GLFWwindow}}* offscreen\_context = \mbox{\hyperlink{group__window_ga680a02abe0e4494b6759d5703240713e}{glfwCreateWindow}}(640, 480, \textcolor{stringliteral}{""}, \mbox{\hyperlink{include_2vally_2config_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}}, \mbox{\hyperlink{include_2vally_2config_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__context_gafd76c93e15ec8b0b90506a9936a46185}{glfwMakeContextCurrent}}(\mbox{\hyperlink{truetype__test__win32_8c_a773143cded4dde4b20b2c5dc501a5b51}{window}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__window_ga3c96d80d363e67d13a41b5d1821f3242}{GLFWwindow}}* \mbox{\hyperlink{truetype__test__win32_8c_a773143cded4dde4b20b2c5dc501a5b51}{window}} = \mbox{\hyperlink{group__context_gac28d98c655377d81a516bf5ef90780c8}{glfwGetCurrentContext}}();}
\end{DoxyCode}
...
\begin{DoxyItemize}
\item An extension name (e.\+g. {\ttfamily G\+L\+\_\+\+A\+R\+B\+\_\+gl\+\_\+spirv})
\item New Open\+GL tokens (e.\+g. {\ttfamily G\+L\+\_\+\+S\+P\+I\+R\+\_\+\+V\+\_\+\+B\+I\+N\+A\+R\+Y\+\_\+\+A\+RB})
\item New Open\+GL functions (e.\+g. {\ttfamily gl\+Specialize\+Shader\+A\+RB})
\end{DoxyItemize}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{preprocessor}{\#include <\mbox{\hyperlink{glad_8h}{glad/glad.h}}>}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{truetype__test__win32_8c_a773143cded4dde4b20b2c5dc501a5b51}{window}} = \mbox{\hyperlink{group__window_ga680a02abe0e4494b6759d5703240713e}{glfwCreateWindow}}(640, 480, \textcolor{stringliteral}{"My Window"}, \mbox{\hyperlink{include_2vally_2config_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}}, \mbox{\hyperlink{include_2vally_2config_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}});}
\DoxyCodeLine{\textcolor{keywordflow}{if} (!\mbox{\hyperlink{truetype__test__win32_8c_a773143cded4dde4b20b2c5dc501a5b51}{window}})}
\DoxyCodeLine{\{}
\DoxyCodeLine{    ...}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{group__context_gafd76c93e15ec8b0b90506a9936a46185}{glfwMakeContextCurrent}}(\mbox{\hyperlink{truetype__test__win32_8c_a773143cded4dde4b20b2c5dc501a5b51}{window}});}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{glad_8h_a1f34fdf1c2f94c05c53d2a1cd3d80537}{gladLoadGLLoader}}((\mbox{\hyperlink{glad_8h_a4f921f2caf007aba097ee85a9f464bce}{GLADloadproc}}) \mbox{\hyperlink{group__context_ga0e8af175218929615c16e74938c10f2a}{glfwGetProcAddress}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordflow}{if} (\mbox{\hyperlink{glad_8h_afb3a3f8b605ffb804f5d1d574d5cc5b4}{GLAD\_GL\_VERSION\_3\_2}})}
\DoxyCodeLine{\{}
...
The header defines function pointer types for all functions of all extensions it supports. These have names like {\ttfamily P\+F\+N\+G\+L\+S\+P\+E\+C\+I\+A\+L\+I\+Z\+E\+S\+H\+A\+D\+E\+R\+A\+R\+B\+P\+R\+OC} (for {\ttfamily gl\+Specialize\+Shader\+A\+RB}), i.\+e. the name is made uppercase and {\ttfamily P\+FN} (pointer to function) and {\ttfamily P\+R\+OC} (procedure) are added to the ends.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{PFNGLSPECIALIZESHADERARBPROC pfnSpecializeShaderARB = \mbox{\hyperlink{group__context_ga0e8af175218929615c16e74938c10f2a}{glfwGetProcAddress}}(\textcolor{stringliteral}{"glSpecializeShaderARB"});}
\end{DoxyCode}
