...
\DoxyCodeLine{\mbox{\hyperlink{group__monitor_ga8d9efd1cde9426692c73fe40437d0ae3}{GLFWmonitor}}** \mbox{\hyperlink{glext_8h_a3c0106911a867ae012fd008394e41257}{monitors}} = \mbox{\hyperlink{group__monitor_gab4d483284c57e28837bc2cd9639e9665}{glfwGetMonitors}}(\&\mbox{\hyperlink{glad_8h_a5b40aca7a9682963dd00a8f5aef0a901}{count}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} monitor\_callback(\mbox{\hyperlink{group__monitor_ga8d9efd1cde9426692c73fe40437d0ae3}{GLFWmonitor}}* monitor, \textcolor{keywordtype}{int} \mbox{\hyperlink{glext_8h_a03b04a5a978bad576866339075de01f6}{event}})}
\DoxyCodeLine{\{}
...
Video modes are represented as \mbox{\hyperlink{struct_g_l_f_wvidmode}{G\+L\+F\+Wvidmode}} structures. You can get an array of the video modes supported by a monitor with \mbox{\hyperlink{group__monitor_ga4fcbc9865c18acb7fbf60cb6c156cef7}{glfw\+Get\+Video\+Modes}}. See the reference documentation for the lifetime of the returned array.


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int} \mbox{\hyperlink{glad_8h_a5b40aca7a9682963dd00a8f5aef0a901}{count}};}
\DoxyCodeLine{\mbox{\hyperlink{struct_g_l_f_wvidmode}{GLFWvidmode}}* \mbox{\hyperlink{unicode_8c_a94c4c0cf850e916912929ee98dbff3fc}{modes}} = \mbox{\hyperlink{group__monitor_ga4fcbc9865c18acb7fbf60cb6c156cef7}{glfwGetVideoModes}}(monitor, \&\mbox{\hyperlink{glad_8h_a5b40aca7a9682963dd00a8f5aef0a901}{count}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int} xpos, ypos, \mbox{\hyperlink{glad_8h_a77a72419a6bb6d8b56f8d9db93a120d0}{width}}, \mbox{\hyperlink{glad_8h_a2e94a4956fa3fc42600a71518b6e6284}{height}};}
\DoxyCodeLine{\mbox{\hyperlink{group__monitor_ga5a3ac0f6e3786df47aabccfb5760b31d}{glfwGetMonitorWorkarea}}(monitor, \&xpos, \&ypos, \&\mbox{\hyperlink{glad_8h_a77a72419a6bb6d8b56f8d9db93a120d0}{width}}, \&\mbox{\hyperlink{glad_8h_a2e94a4956fa3fc42600a71518b6e6284}{height}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{const} \textcolor{keywordtype}{char}* \mbox{\hyperlink{glad_8h_ad977737dfc9a274a62741b9500c49a32}{name}} = \mbox{\hyperlink{group__monitor_ga9bb1b5712a5a4f1478ed74513e02d148}{glfwGetMonitorName}}(monitor);}
\end{DoxyCode}
...
The gamma ramp of a monitor can be set with \mbox{\hyperlink{group__monitor_gac9f36a1cfa10eab191d3029ea8bc9558}{glfw\+Set\+Gamma\+Ramp}}, which accepts a monitor handle and a pointer to a \mbox{\hyperlink{struct_g_l_f_wgammaramp}{G\+L\+F\+Wgammaramp}} structure.


\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{struct_g_l_f_wgammaramp}{GLFWgammaramp}} ramp;}
\DoxyCodeLine{\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{short} red[256], \mbox{\hyperlink{glad_8h_ac14cda87cf6c751d53b65a3cd41c35a1}{green}}[256], \mbox{\hyperlink{glad_8h_a1853b32584a90fa75432925f3e26d0e8}{blue}}[256];}
\DoxyCodeLine{}
\DoxyCodeLine{ramp.\mbox{\hyperlink{struct_g_l_f_wgammaramp_ad620e1cffbff9a32c51bca46301b59a5}{size}} = 256;}
\DoxyCodeLine{ramp.\mbox{\hyperlink{struct_g_l_f_wgammaramp_a2cce5d968734b685623eef913e635138}{red}} = red;}
\DoxyCodeLine{ramp.\mbox{\hyperlink{struct_g_l_f_wgammaramp_affccc6f5df47820b6562d709da3a5a3a}{green}} = \mbox{\hyperlink{glad_8h_ac14cda87cf6c751d53b65a3cd41c35a1}{green}};}
\DoxyCodeLine{ramp.\mbox{\hyperlink{struct_g_l_f_wgammaramp_acf0c836d0efe29c392fe8d1a1042744b}{blue}} = \mbox{\hyperlink{glad_8h_a1853b32584a90fa75432925f3e26d0e8}{blue}};}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{const} \mbox{\hyperlink{struct_g_l_f_wgammaramp}{GLFWgammaramp}}* ramp = \mbox{\hyperlink{group__monitor_gab8c94ec5ac1d43f70ce03a3e845837b2}{glfwGetGammaRamp}}(monitor);}
\end{DoxyCode}
